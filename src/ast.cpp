...
Symbol Program::type_check(Environment& env) const
{
    for (auto& c : classes)
        c->type_check(env);
}

Symbol Class::type_check(Environment& env) const 
{
...
Symbol Attribute::type_check(Environment& env) const
{

}

Symbol Method::type_check(Environment& env) const
{
    env.symtbl.enter_scope();
...
Symbol Formal::type_check(Environment& env) const
{

}

Symbol StringConst::type_check(Environment& env) const
{

}


Symbol IntConst::type_check(Environment& env) const
{

}

Symbol BoolConst::type_check(Environment& env) const
{

}

Symbol New::type_check(Environment& env) const
{
    
}

Symbol IsVoid::type_check(Environment& env) const
{

}

Symbol CaseBranch::type_check(Environment& env) const
{

}

Symbol Assign::type_check(Environment& env) const
{

}

Symbol Block::type_check(Environment& env) const
{

}

Symbol If::type_check(Environment& env) const
{

}

Symbol While::type_check(Environment& env) const
{

}

Symbol Complement::type_check(Environment& env) const
{

}

Symbol LessThan::type_check(Environment& env) const
{

}

Symbol EqualTo::type_check(Environment& env) const
{

}

Symbol LessThanEqualTo::type_check(Environment& env) const
{

}

Symbol Plus::type_check(Environment& env) const
{

}

Symbol Sub::type_check(Environment& env) const
{

}

Symbol Mul::type_check(Environment& env) const
{

}

Symbol Div::type_check(Environment& env) const
{

}

Symbol Not::type_check(Environment& env) const
{

}

Symbol StaticDispatch::type_check(Environment& env) const
{

}

Symbol DynamicDispatch::type_check(Environment& env) const
{

}

Symbol Let::type_check(Environment& env) const
{

}

Symbol Case::type_check(Environment& env) const
{

}

Symbol Object::type_check(Environment& env) const
{
    boost::optional<Symbol> obj_type = env.symtbl.lookup(name);
    return obj_type ? *obj_type : OBJECT;
}

Symbol NoExpr::type_check(Environment& env) const
{
